...
local ACTION_POLICIES = {
  ...
  cleanUpDraft = {
    ...
    prompt_builder = "buildCleanUpDraftPrompt",
    validator = "cleanup_draft",
    profile_behavior = "active_clipboard_profile",
    requires_clipboard = true,
    menu_only = true,
  ...
  turnIntoBullets = {
    action = "turnIntoBullets",
    label = "Turn Into Bullets",
    prompt_builder = "buildTurnIntoBulletsPrompt",
    validator = "bullets",
    profile_behavior = "active_clipboard_profile",
    requires_clipboard = true,
    menu_only = true,
  ...
  turnIntoActionItems = {
    action = "turnIntoActionItems",
    label = "Turn Into Action Items",
    prompt_builder = "buildTurnIntoActionItemsPrompt",
  ...
  replyDraft = {
    action = "replyDraft",
    label = "Reply Draft",
    prompt_builder = "buildReplyDraftPrompt",
    validator = "reply_draft",
    profile_behavior = "active_clipboard_profile",
    requires_clipboard = true,
    menu_only = true,
    hotkey_enabled = false,
  ...
  titlePack = {
    action = "titlePack",
    label = "Title Pack",
    prompt_builder = "buildTitlePackPrompt",
    validator = "title_pack",
    profile_behavior = "active_clipboard_profile",
    requires_clipboard = true,
    menu_only = true,
    hotkey_enabled = false,
  ...
  renameFilesPlan = {
    action = "renameFilesPlan",
    label = "Rename Files Plan",
    prompt_builder = "buildRenameFilesPlanPrompt",
    validator = "rename_plan",
    profile_behavior = "active_clipboard_profile",
    requires_clipboard = false,
    requires_finder = true,
    menu_only = true,
    hotkey_enabled = false,
    default_context = {
      finder = true,
  ...
  processFilesPlan = {
    action = "processFilesPlan",
    label = "Process Files Plan",
    prompt_builder = "buildProcessFilesPlanPrompt",
    validator = "process_plan",
    profile_behavior = "active_clipboard_profile",
    requires_clipboard = false,
    requires_finder = true,
    menu_only = true,
  ...
  explainThisFolder = {
    action = "explainThisFolder",
    label = "Explain This Folder",
    prompt_builder = "buildExplainThisFolderPrompt",
    validator = "folder_explain",
    profile_behavior = "active_clipboard_profile",
    requires_clipboard = false,
    requires_finder = true,
    menu_only = true,
  ...
  generateCommand = {
    ...
    prompt_builder = "buildGenerateCommandPrompt",
    validator = "command_block",
    profile_behavior = "active_clipboard_profile",
    requires_clipboard = false,
    requires_finder = true,
    menu_only = true,
